...
- ✅ **`check:spelling` is GREEN again as of 2026-08-26.** It was red on six
  ...
  taught, though — when `check:all` goes red, read _which_ check failed before
