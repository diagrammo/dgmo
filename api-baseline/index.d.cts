 ...
 */
declare function emit(spec: DiagnosticSpec, line: number, params?: DiagnosticParams, opts?: EmitOptions): DgmoError;
...
export { type ChartTypeMeta, type CompactViewState, D3_DATA_CHART_TYPES, type DataChartInteractionOpts, type DecodedDiagramUrl, type DgmoError, type DgmoSeverity, type DiagnosticParams, type DiagnosticSpec, type EmitOptions, type EncodeDiagramUrlOptions, type Gazetteer, type GazetteerEntry, type MapCompletionOptions, type MapData, type MapLocationMatch, type MapPlaceCompletion, type MapRegionCompletion, type MountD3Opts, type MountedD3Chart, type PaletteColors, type PaletteConfig, type RegionName, type RegionNames, type RenderOptions, type RenderResult, type Theme, attachDataChartInteractions, chartTypes, completeMapPlaces, completeMapRegions, decodeDiagramUrl, emit, encodeDiagramUrl, formatDgmoError, getDiagnosticSpec, getEmbedSvgViewBox, getMinDimensions, getPalette, listDiagnosticCodes, mountD3DataChart, normalizeSvgForEmbed, palettes, render, resolvePaletteOrFallback, searchMapLocations, supportsD3DataChart, themes, parseDgmo as validate };
