 ...
 */
declare function validateLabelCharacters(
  label: string,
  lineNumber: number
): DgmoError[];
 ...
 * pure label text.
 */
declare function parseInArrowLabel(
  rawLabel: string,
  lineNumber: number
 ...
 */
declare function parseDataRowValues(
  line: string,
  options?: {
    multiValue?: boolean;
 ...
 * ```
 */
declare function parseExtendedChart(
  content: string,
  palette?: PaletteColors
): ParsedExtendedChart;
/**
 ...
 */
declare function getExtendedChartLegendGroups(
 ...
 */
declare function computeTimeTicks(
  domainMin: number,
  domainMax: number,
...
declare function layoutGraph(
  graph: ParsedGraph,
  options?: LayoutOptions$1
): LayoutResult$1;

declare function renderState(
  container: HTMLDivElement,
  graph: ParsedGraph,
...
declare function renderStateForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
 ...
 */
declare function collapseStateGroups(
  parsed: ParsedGraph,
...
declare function parseClassDiagram(
  content: string,
  palette?: PaletteColors
): ParsedClassDiagram;
/**
...
declare function layoutClassDiagram(
  parsed: ParsedClassDiagram,
  options?: ClassLayoutOptions
): ClassLayoutResult;

declare function renderClassDiagram(
  container: HTMLDivElement,
  parsed: ParsedClassDiagram,
...
declare function renderClassDiagramForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
...
declare function parseERDiagram(
  content: string,
  palette?: PaletteColors
): ParsedERDiagram;
/**
...
declare function layoutERDiagram(
  parsed: ParsedERDiagram,
  options?: ERLayoutOptions
): ERLayoutResult;

declare function renderERDiagram(
  container: HTMLDivElement,
  parsed: ParsedERDiagram,
...
declare function renderERDiagramForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
 ...
 */
declare function getOrCreateName(
  input: string,
...
declare function collapseOrgTree(
  original: ParsedOrg,
 ...
 */
declare function focusOrgTree(
  original: ParsedOrg,
  focusNodeId: string
): FocusOrgResult | null;

declare function renderOrg(
  container: HTMLDivElement,
  parsed: ParsedOrg,
...
declare function renderOrgForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
 ...
 */
declare function computeCardMove(
  content: string,
  parsed: ParsedKanban,
  cardId: string,
 ...
 */
declare function computeCardArchive(
  content: string,
  parsed: ParsedKanban,
  cardId: string
): string | null;
...
declare function renderKanbanForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
 ...
 */
declare function rollUpContextRelationships(
  parsed: ParsedC4
): ContextRelationship[];
declare function layoutC4Context(
  parsed: ParsedC4,
  activeTagGroup?: string | null
): C4LayoutResult;
/**
 ...
 */
declare function layoutC4Containers(
  parsed: ParsedC4,
  systemName: string,
  activeTagGroup?: string | null
): C4LayoutResult;
 ...
 */
declare function layoutC4Components(
  parsed: ParsedC4,
  systemName: string,
 ...
 */
declare function layoutC4Deployment(
  parsed: ParsedC4,
  activeTagGroup?: string | null
): C4LayoutResult;

declare function renderC4Context(
  container: HTMLDivElement,
  parsed: ParsedC4,
...
declare function renderC4ContextForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
 ...
 */
declare function renderC4Containers(
  container: HTMLDivElement,
  parsed: ParsedC4,
  layout: C4LayoutResult,
  palette: PaletteColors,
...
declare function renderC4ContainersForExport(
  content: string,
  systemName: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
declare function renderC4ComponentsForExport(
  content: string,
  systemName: string,
  containerName: string,
  theme: 'light' | 'dark' | 'transparent',
 ...
 */
declare function renderC4Deployment(
  container: HTMLDivElement,
  parsed: ParsedC4,
  layout: C4LayoutResult,
  palette: PaletteColors,
 ...
 */
declare function renderC4DeploymentForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
...
declare function parseBoxesAndLines(
  content: string,
  palette?: PaletteColors
): ParsedBoxesAndLines;
...
declare function layoutBoxesAndLines(
...
declare function renderBoxesAndLinesForExport(
  container: HTMLDivElement,
  parsed: ParsedBoxesAndLines,
  layout: BLLayoutResult,
  palette: PaletteColors,
 ...
 * - Collapsed groups removed from groups[] (layout handles as nodes)
 */
declare function collapseBoxesAndLines(
  parsed: ParsedBoxesAndLines,
  collapsedGroups: Set<string>
): BLCollapseResult;
...
declare function parseSwimlane(
  content: string,
  palette?: PaletteColors
): ParsedSwimlane;
...
declare function renderSwimlaneForExport(
  container: HTMLElement,
...
declare function layoutSitemap(
...
declare function renderSitemap(
  container: HTMLDivElement,
  parsed: ParsedSitemap,
...
declare function renderSitemapForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette?: PaletteColors
): Promise<string>;
...
declare function collapseSitemapTree(
 ...
 */
declare function validateComputed(
 ...
 */
declare function collectDiagramRoles(
...
declare function computeInfraLegendGroups(
...
declare function buildTagLaneRowList(
  resolved: ResolvedSchedule,
...
declare function resolveTaskName(
  name: string,
  allTasks: GanttTask[]
): ResolverResult;
 ...
 */
declare function sampleBetaPert(
  o: number,
  m: number,
  p: number,
  rng: () => number
 ...
 */
declare function simulateCanonical(
  resolved: ResolvedPert,
...
declare function renderPertForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors,
  /**
 ...
 */
declare function measurePertAnalysisBlock(
  resolved: ResolvedPert,
  width: number,
  options: {
    showSummary?: boolean;
 ...
 */
declare function renderPertAnalysisBlock(
  container: HTMLDivElement,
  resolved: ResolvedPert,
  palette: PaletteColors,
  isDark: boolean,
...
declare function parseMindmap(
  content: string,
  palette?: PaletteColors
): ParsedMindmap;

declare function layoutMindmap(
...
declare function renderMindmap(
  container: HTMLDivElement,
  parsed: ParsedMindmap,
...
declare function renderMindmapForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
...
declare function collapseMindmapTree(
...
declare function layoutWireframe(
...
declare function renderWireframe(
  container: HTMLDivElement,
  parsed: ParsedWireframe,
 ...
 */
declare function computeRadarLayout(
 ...
 */
declare function getRadarGeometry(
  width: number,
  height: number,
  ringCount: number
): {
...
declare function renderTechRadar(
  container: HTMLDivElement,
  parsed: ParsedTechRadar,
  palette: PaletteColors,
  isDark: boolean,
...
declare function renderTechRadarForExport(
  container: HTMLDivElement,
  parsed: ParsedTechRadar,
  palette: PaletteColors,
  isDark: boolean,
...
declare function renderQuadrantFocus(
  container: HTMLDivElement,
  parsed: ParsedTechRadar,
...
declare function renderQuadrantFocusForExport(
  container: HTMLDivElement,
  parsed: ParsedTechRadar,
  quadrantPosition: QuadrantPosition,
  palette: PaletteColors,
 ...
 */
declare function computeCycleLayout(
  parsed: ParsedCycle,
  options?: {
    width?: number;
    height?: number;
 ...
 */
declare function renderCycleForExport(
  container: HTMLDivElement,
  parsed: ParsedCycle,
  palette: PaletteColors,
  isDark: boolean,
...
declare function parseJourneyMap(
  content: string,
  palette?: PaletteColors
): ParsedJourneyMap;
...
declare function layoutJourneyMap(
...
declare function renderJourneyMap(
  container: HTMLElement,
  parsed: ParsedJourneyMap,
  palette: PaletteColors,
  isDark: boolean,
...
declare function renderJourneyMapForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
 ...
 */
declare function renderPyramid(
  container: HTMLDivElement,
 ...
 * Render for CLI/export (no click handlers).
 */
declare function renderPyramidForExport(
  container: HTMLDivElement,
  parsed: ParsedPyramid,
  palette: PaletteColors,
  isDark: boolean,
...
declare function parseEventLine(
  content: string,
  palette?: PaletteColors
): ParsedEventLine;

declare function renderEventLine(
  container: HTMLDivElement,
 ...
 */
declare function focusEventLine(
  container: HTMLElement,
  spec: EventLineFocus | null
): void;
declare function renderEventLineForExport(
  container: HTMLDivElement,
  parsed: ParsedEventLine,
  palette: PaletteColors,
  isDark: boolean,
...
declare function parseVersionControl(
  content: string,
  palette?: PaletteColors
): ParsedVersionControl;

declare function renderVersionControl(
  container: HTMLDivElement,
...
declare function renderVersionControlForExport(
  container: HTMLDivElement,
  parsed: ParsedVersionControl,
  palette: PaletteColors,
  isDark: boolean,
 ...
 * Render for CLI/export (no click handlers).
 */
declare function renderRingForExport(
  container: HTMLDivElement,
  parsed: ParsedRing,
  palette: PaletteColors,
  isDark: boolean,
...
declare function renderTreemapForExport(
  container: HTMLDivElement,
...
declare function renderTreemap(
  container: HTMLDivElement,
  parsed: ParsedTreemap,
  palette: PaletteColors,
  isDark: boolean,
...
declare function layoutTreemap(
...
declare function renderBlockForExport(
  container: HTMLDivElement,
  parsed: ParsedBlock,
  palette: PaletteColors,
  isDark: boolean,
...
declare function mapBackgroundColor(
  palette: PaletteColors,
  isDark?: boolean,
  _dataActive?: boolean
): string;
...
declare function mapNeutralLandColor(
  palette: PaletteColors,
  isDark: boolean,
  _dataActive?: boolean
): string;
...
declare function renderMapForExport(
  container: HTMLDivElement,
  resolved: ResolvedMap,
  data: MapData,
  palette: PaletteColors,
...
declare function mapContentAspect(
  resolved: ResolvedMap,
  data: MapData,
...
declare function mapExportDimensions(
  resolved: ResolvedMap,
  data: MapData,
  baseWidth?: number,
...
declare function renderRaciForExport(
  container: HTMLDivElement,
  parsed: ParsedRaci,
  palette: PaletteColors,
  isDark: boolean,
 ...
 */
declare function cellAppendMarker(
  content: string,
  parsed: ParsedRaci,
  taskId: string,
  roleId: string,
 ...
 */
declare function resolveOrgImports(
  content: string,
  filePath: string,
  readFileFn: ReadFileFn
): Promise<ResolveImportsResult>;

declare function renderFlowchart(
  container: HTMLDivElement,
  graph: ParsedGraph,
  layout: LayoutResult$1,
  palette: PaletteColors,
...
declare function renderFlowchartForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette: PaletteColors
): string;
...
declare function renderLegendSvg(
  groups: readonly LegendGroupData[],
  options: LegendRenderOptions
): LegendRenderResult;
declare function renderLegendSvgFromConfig(
  config: LegendConfig,
  state: LegendState,
...
declare function renderLegendD3(
  container: D3Sel,
  config: LegendConfig,
  state: LegendState,
  palette: LegendPalette,
...
declare function controlsGroupCapsuleWidth(
  toggles: Array<{
    label: string;
  }>
): number;
declare function computeLegendLayout(
  config: LegendConfig,
  state: LegendState,
  containerWidth: number
): LegendLayout;
declare function getLegendReservedHeight(
  config: LegendConfig,
  state: LegendState,
  containerWidth: number
): number;
 ...
 */
declare function groupMessagesBySection(
 ...
 */
declare function buildRenderSequence(
  messages: readonly SequenceMessage[]
): RenderStep[];
 ...
 */
declare function applyPositionOverrides(
 ...
 */
declare function applyGroupOrdering(
  participants: readonly SequenceParticipant[],
 ...
 */
declare function renderSequenceDiagram(
  container: HTMLDivElement,
 ...
 */
declare function buildNoteMessageMap(
  elements: readonly SequenceElement[]
): Map<number, number>;
 ...
 */
declare function applyCollapseProjection(
  parsed: ParsedSequenceDgmo,
  collapsedGroups: Set<number>
): CollapsedView;
 ...
 */
declare const RECOGNIZED_COLOR_NAMES: readonly [
  'red',
  'orange',
  'yellow',
  'green',
 ...
 */
declare function resolveColorWithDiagnostic(
  color: string,
  line: number,
  diagnostics: DgmoError[],
  palette?: {
...
export {
  ...
  type GanttEra,
  type GanttGroup,
  type GroupRow as GanttGroupRow,
  type GanttHolidays,
  type GanttInteractiveOptions,
  type LaneHeaderRow as GanttLaneHeaderRow,
  type GanttMarker,
  type GanttNode,
  type GanttOptions,
  ...
  type InfraBehaviorKey,
  type InfraCbState,
  type InfraComputeParams,
  type InfraDiagnostic,
  type InfraEdge,
  type InfraGroup,
  type InfraLatencyPercentiles,
  type InfraLayoutEdge,
  type InfraLayoutGroup,
  type InfraLayoutNode,
  type InfraLayoutResult,
  type InfraLegendGroup,
  type InfraNode,
  type InfraPlaybackState,
  type InfraProperty,
  type InfraRole,
  type InfraTagGroup,
  type InlineSpan,
  type JourneyMapAnnotation,
  type JourneyMapInteractiveOptions,
  ...
  type LayoutGroup,
  type LayoutNode,
  type LayoutOptions$1 as LayoutOptions,
  type LayoutResult$1 as LayoutResult,
  type LegendCallbacks,
  type LegendConfig,
  type LegendControl,
  ...
  type ParsedC4,
  type ParsedChart,
  type ParsedClassDiagram,
  type ParsedCycle,
  type ParsedERDiagram,
  ...
  type ParsedRaci,
  type ParsedRing,
  type ParsedSequenceDgmo,
  type ParsedSitemap,
  type ParsedSwimlane,
  type ParsedTechRadar,
  type ParsedTreemap,
  type ParsedVersionControl,
  type ParsedVisualization,
  type ParsedWireframe,
  type ParticipantType,
  type PertActivity,
  type Anchor as PertAnchor,
  type PertDirection,
  type PertEdge,
  type PertGroup,
  type PertLayoutEdge,
  type PertLayoutGroup,
  type PertLayoutNode,
  type LayoutOverrides as PertLayoutOverrides,
  type LayoutResult as PertLayoutResult,
  type PertMilestone,
  type PertOptions,
  ...
  type SitemapContainerBounds,
  type SitemapDirection,
  type SitemapEdge,
  type SitemapLayoutEdge,
  type SitemapLayoutNode,
  type SitemapLayoutResult,
  type SitemapLegendEntry,
