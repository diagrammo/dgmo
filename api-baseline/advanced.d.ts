 ...
 */
declare function buildExtendedChartOption(
 ...
 */
declare function computeScatterLabelGraphics(
 ...
 */
declare function buildSimpleChartOption(
  parsed: ParsedChart,
  palette: PaletteColors,
  isDark: boolean,
  chartWidth?: number,
 ...
 */
declare function renderExtendedChartForExport(
  content: string,
  theme: 'light' | 'dark' | 'transparent',
  palette?: PaletteColors
): Promise<string>;
